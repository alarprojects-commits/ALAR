...
<section class="alar-section">
    <div class="alar-wrap alar-prose">
        ...
        <div class="alar-faq">
            <details open><summary>What personal information do you use for a ride?</summary><p>Name, phone, email, and trip details from the contact form or booking page are used to quote and dispatch that ride. A flight number is used to watch the arrival. An address is used to send the chauffeur.</p></details>
            <details><summary>Are text messages required to book?</summary><p>No. SMS consent is optional. If you opt in, messages follow your reservations: a confirmation, a change, or a chauffeur update. Reply STOP to cancel.</p></details>
            <details><summary>Do you invent Google reviews?</summary><p>No. Reviews shown on the site come from Google’s listing. Requests to remove a review go to Google because we do not host the original.</p></details>
            <details><summary>How do I ask about my data?</summary><p>Email or call the contact details in section 12 to ask what we hold, request a correction, or ask us to delete information we no longer need for a trip, receipt, or legal duty.</p></details>
        </div>
        <p>People open this page for a few practical questions, not for a tour of the company. Those questions are answered above in ordinary language. The numbered sections are the policy. This part does not add new uses of your information.</p>
        <p>If you send a ride request through the <a href="{{ route('contact-us') }}">contact form</a> or the <a href="{{ route('book-online') }}">booking page</a>, we use your name, phone, email, and trip details to quote and dispatch that ride. Payment details, when a booking tool collects them, are handled by that booking tool. This site’s policy does not control a third-party checkout.</p>
