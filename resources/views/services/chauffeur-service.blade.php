...
@section('content')
@include('components.page-banner', ['image' => asset('assets/img/services/chauffeur-service/banner.png'), 'kicker' => 'Private', 'title' => 'Chauffeur service New Jersey and private car NYC NJ', 'crumbs' => [['label' => 'Services', 'url' => route('our-services')], ['label' => 'Chauffeured Service']]])
...
<section class="alar-section alar-paper">
    <div class="alar-wrap alar-prose">
        ...
        <p>For a New Jersey office day with a flight, read <a href="{{ route('blog.corporate-car-service-new-jersey') }}">corporate car service in New Jersey</a>.</p>
