...
@section('content')
@include('components.page-banner', ['image' => asset('assets/img/airports/jfk/banner.png'), 'modifier' => 'alar-banner-tall', 'kicker' => 'JFK', 'title' => 'JFK car service and airport limo', 'crumb' => 'JFK'])
        ...
        <div class="alar-guide-shell">
            ...
            <div class="alar-guide-panels">
                <article id="jfk-arrivals" class="alar-guide-panel is-on">
                    <div class="alar-guide-media" style="background-image:url('{{ asset('assets/img/airports/jfk/photo.png') }}')"></div>
                ...
                <article id="jfk-quote" class="alar-guide-panel">
                    ...
                    <div class="alar-guide-copy">
                        ...
                        <p>Compare black car service with apps and street hail in our article on <a href="{{ route('blog.black-car-service-nyc-vs-uber-taxi') }}">black car service versus Uber and taxi</a> when you are deciding how to book this trip.</p>
                        <div class="alar-guide-actions">
                            <a class="alar-btn alar-btn-gold" href="{{ route('book-online') }}">Book Online</a>
                            <a class="alar-btn alar-btn-line" href="{{ route('contact-us') }}">Request a Quote</a>
                        </div>
